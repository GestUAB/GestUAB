	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				for ( i=iStartButton ; i<=iEndButton ; i++ )
				{
					if ( iCurrentPage != i )
					{
						sList += '<a href="#"><span class="'+oClasses.sPageButton+'">'+i+'</span></a>';
					}
					else
					{
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sZeroRecords": "Não existem registros cadastrados que atendam ao filtro.",
				"sInfo": "Exibindo _START_ a _END_ de _TOTAL_",
				"sInfoEmpty": "Exibindo 0 a 0 d 0",
				"sInfoFiltered": "(filtrado de _MAX_ registros no total)",
				"sInfoPostFix": "",
				"sSearch": "<b>Localização Rápida:</b>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "",
					"sPrevious": "Anterior",
...
jQuery.fn.dataTableExt.oSort['uk_referencia-asc']  = function(a,b) {
	var ukDatea = a.split('/');
	var ukDateb = b.split('/');
...
jQuery.fn.dataTableExt.oSort['uk_referencia-desc'] = function(a,b) {
	var ukDatea = a.split('/');
	var ukDateb = b.split('/');
...
jQuery.fn.dataTableExt.aTypes.push(
	function ( sData )
	{
		if (sData.match(/^(0[1-9]|1[012])\/(19|20|21)\d\d$/))
		{
			return 'uk_referencia';
		}
		return null;
	}
